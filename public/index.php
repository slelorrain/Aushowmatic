...
<div id="remote">
    ...
    <ul class="yt-button-group">
        ...
        <li><a href="?a=transmission&param=altSpeedOff" class="yt-button <?php if (!$isTurtleActivated) {
                echo 'active';
            } ?>" title="Turtle OFF">&infin;</a></li>
    </ul>
    <ul class="yt-button-group">
...
<div id="main_container" class="auto">
    ...
    <nav>
        <ul class="yt-button-group left">
            <li><a href="?a=done" class="yt-button <?php if (isset($_GET['a']) && $_GET['a'] == 'done') {
                    echo 'active';
                } ?>">Processed links</a></li>
            <li><a href="?a=shows" class="yt-button <?php if (isset($_GET['a']) && $_GET['a'] == 'shows') {
                    echo 'active';
                } ?>">Added shows</a></li>
        </ul>
        <ul class="yt-button-group left">
        ...
        <ul class="yt-button-group right">
            <li><a href="?a=preview" class="yt-button <?php if (isset($_GET['a']) && $_GET['a'] == 'preview') {
                    echo 'active';
                } ?>">Preview downloads</a></li>
            <li><a href="?a=launch" class="yt-button primary <?php if (isset($_GET['a']) && $_GET['a'] == 'launch') {
                    echo 'active';
                } ?>">Launch downloads</a></li>
        </ul>
        <div class="clear"></div>
    ...
    <pre id="response"><?php if (isset($_SESSION['result'])) {
